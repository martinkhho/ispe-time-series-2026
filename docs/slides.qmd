...
## Motivating example[@gomes2017association] - BGTS utilization & costs

![BGTS utilization and costs in Ontario](assets/images/example_bgts_utilization_cost.png){fig-alt="Utilization and costs" height="500px" fig-align="center"}


## Motivating example[@gomes2017association] - clinical outcomes
...
![Rates of emergency department visits for hypoglycemia and hyperglycemia](assets/images/example_bgts_hypoglc_hyperglc.png){fig-alt="ED visits for hypoglycemia and hyperglycemia" height="500px" fig-align="center"}


## Motivating example - mean HbA1c

![Mean HbA1c (overall and among high-use cohort)](assets/images/example_bgts_hba1c.png){fig-alt="Mean HbA1c" height="500px" fig-align="center"}
...
- Sign (+/-) of autocorrelation does not matter for identifying AR and MA orders
...
- You can model multiple interventions (e.g., step + ramp)[@schaffer2021interrupted]
